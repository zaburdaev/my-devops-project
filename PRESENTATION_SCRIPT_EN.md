...
> The application is running in production on AWS, accessible at **18.197.7.122**, and the entire process from commit to deploy is fully automated."
...
> - **Elastic IP** - static IP address (18.197.7.122)
...
*[Here you can switch to browser and show Grafana at 18.197.7.122:3000]*
...
1. Open browser
2. Navigate to **http://18.197.7.122**
3. Show homepage
...
1. Open new tab: **http://18.197.7.122:3000**
...
1. Open terminal
2. SSH to server: `ssh ubuntu@18.197.7.122`
3. Run commands:
   ```bash
...
**Check functionality:**
- [ ] Application accessible: http://18.197.7.122
- [ ] Grafana working: http://18.197.7.122:3000
- [ ] Prometheus collecting metrics: http://18.197.7.122:9090
