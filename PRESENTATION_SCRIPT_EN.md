...
> The application is running in production on AWS, accessible at **3.127.155.114**, and the entire process from commit to deploy is fully automated."
...
> - **Elastic IP** - static IP address (3.127.155.114)
...
*[Here you can switch to browser and show Grafana at 3.127.155.114:3000]*
...
> 
> **Project Access:**
> - 🌐 Application: http://3.127.155.114
...
1. Open browser
2. Navigate to **http://3.127.155.114**
3. Show homepage
...
1. Open new tab: **http://3.127.155.114:3000**
...
1. Open terminal
2. SSH to server: `ssh ubuntu@3.127.155.114`
3. Run commands:
   ```bash
...
**Check functionality:**
- [ ] Application accessible: http://3.127.155.114
- [ ] Grafana working: http://3.127.155.114:3000
- [ ] Prometheus collecting metrics: http://3.127.155.114:9090
