...
3. Change value from: `18.156.160.162`
4. Change to: `18.156.160.162`
...
│                                          │
│ Elastic IP:  18.156.160.162  ✅ ACTIVE │
│ Allocation:  eipalloc-0f1d885679fa634f8│
│ Region:      eu-central-1 (Frankfurt)   │
│                                          │
│ OLD IP:      18.156.160.162     ❌ LOST │
...
### Can You Get 18.156.160.162 Back?
...
- [ ] `SERVER_HOST`: 18.156.160.162 → **18.156.160.162**
...
find . -type f \( -name "*.md" -o -name "*.txt" \) -exec sed -i 's/3\.127\.155\.114/18.156.160.162/g' {} \;
```
...
**Immediate (Required):**
1. Update GitHub Secrets: `SERVER_HOST = 18.156.160.162`
