...
- ✅ **AWS деплой** — развёрнут на EC2 (18.197.7.122)
...
| Компонент | Статус |
|-----------|--------|
| **AWS EC2** | ✅ Развёрнут (18.197.7.122) |
...
Проект использует **AWS Elastic IP** `18.197.7.122`, поэтому внешний IP остаётся стабильным даже при пересоздании EC2.
