...
> **AWS:** Развёрнут на `18.156.160.162`  
...
- ✅ **AWS деплой** — развёрнут на EC2 (18.156.160.162)
...
| Компонент | Статус |
|-----------|--------|
| **AWS EC2** | ✅ Развёрнут (18.156.160.162) |
...
Проект использует **AWS Elastic IP** `18.156.160.162`, поэтому внешний IP остаётся стабильным даже при пересоздании EC2.
