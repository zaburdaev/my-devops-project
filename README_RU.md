...
- ✅ **AWS деплой** — развёрнут на EC2 (52.59.86.193)
...
| Компонент | Статус |
|-----------|--------|
| **AWS EC2** | ✅ Развёрнут (52.59.86.193) |
...
Проект использует **AWS Elastic IP** `52.59.86.193`, поэтому внешний IP остаётся стабильным даже при пересоздании EC2.
