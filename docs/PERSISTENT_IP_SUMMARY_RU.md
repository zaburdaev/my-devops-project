...
║  └── SSH:         ssh -i key.pem ec2-user@18.197.7.122          ║
║                                                                  ║
╚══════════════════════════════════════════════════════════════════╝
```
...
│     ├── Elastic IP   → ♻️  Переиспользовать (18.197.7.122)     │
...
│                                                                 │
│  5️⃣  ВЕРИФИКАЦИЯ                                               │
│     ├── App:        ✅ http://18.197.7.122                      │
│     ├── Grafana:    ✅ http://18.197.7.122:3000                 │
│     └── Prometheus: ✅ http://18.197.7.122:9090                 │
│                                                                 │
│  РЕЗУЛЬТАТ: IP остался 18.197.7.122 ✅                         │
└─────────────────────────────────────────────────────────────────┘
```
...
| Приложение | ✅ | Доступно по `http://18.197.7.122` |
| Grafana | ✅ | Доступна по `http://18.197.7.122:3000` |
| Prometheus | ✅ | Доступен по `http://18.197.7.122:9090` |
...
┌──────────────────────────────────────────────────────────────┐
│                                                              │
│  ✅ Elastic IP 18.197.7.122 теперь ПОСТОЯННЫЙ               │
│                                                              │
