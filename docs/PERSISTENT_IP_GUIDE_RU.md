...
```
Восстановление #1 → IP: 52.59.86.193 ← ВСЕГДА ОДИН И ТОТ ЖЕ
Восстановление #2 → IP: 52.59.86.193 ← ВСЕГДА ОДИН И ТОТ ЖЕ
Восстановление #3 → IP: 52.59.86.193 ← ВСЕГДА ОДИН И ТОТ ЖЕ
```
...
└── 🔗 EIP Association — ОБНОВЛЯЕТСЯ
    └── 52.59.86.193 привязывается к НОВОМУ инстансу
```
...
curl http://52.59.86.193
curl http://52.59.86.193:3000/api/health
curl http://52.59.86.193:9090/-/healthy
```
...
╔═══════════════════════════════════════════════════════╗
║                                                       ║
║  🔒 IP-адрес 52.59.86.193 — ПОСТОЯННЫЙ              ║
║                                                       ║
