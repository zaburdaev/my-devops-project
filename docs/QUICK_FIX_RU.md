...
|--------|---------------------|---------------|----------|
| Приложение | http://localhost:5000 | http://52.59.86.193:5000 | Flask API |
| Nginx | http://localhost:80 | http://52.59.86.193 | Реверс-прокси |
| Grafana | http://localhost:3000 | http://52.59.86.193:3000 | Мониторинг |
| Prometheus | http://localhost:9090 | http://52.59.86.193:9090 | Метрики |
