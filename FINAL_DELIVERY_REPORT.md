...
- **Changes:**
  - All IP addresses updated to Elastic IP: 18.197.7.122
...
1. **Live Application**
   - Open: http://18.197.7.122:5000/health
   - Show: Healthy status response

2. **Grafana Dashboard**
   - Open: http://18.197.7.122:3000
