...
- **Changes:**
  - All IP addresses updated to Elastic IP: 3.127.155.114
...
1. **Live Application**
   - Open: http://3.127.155.114:5000/health
   - Show: Healthy status response

2. **Grafana Dashboard**
   - Open: http://3.127.155.114:3000
