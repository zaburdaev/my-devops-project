...
- Проверено использование IP `3.127.155.114` в root/docs файлах
...
Базовые параметры (6 сервисов, без Loki, Grafana через `.env`, IP `3.127.155.114`, Prometheus 60s) синхронизированы в основной документации.
