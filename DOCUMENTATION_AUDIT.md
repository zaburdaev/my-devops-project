...
- Проверено использование IP `18.156.160.162` в root/docs файлах
...
Базовые параметры (6 сервисов, без Loki, Grafana через `.env`, IP `18.156.160.162`, Prometheus 60s) синхронизированы в основной документации.
