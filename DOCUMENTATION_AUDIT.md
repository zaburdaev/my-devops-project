...
- Проверено использование IP `18.197.7.122` в root/docs файлах
...
Базовые параметры (6 сервисов, без Loki, Grafana через `.env`, IP `18.197.7.122`, Prometheus 60s) синхронизированы в основной документации.
